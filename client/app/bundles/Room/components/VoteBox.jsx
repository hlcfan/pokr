...
export default class VoteBox extends React.Component {
  ...
  componentDidMount() {
    ...
    this.props.addSteps({
      title: 'Deck',
      text: 'All the points are listed in this panel. Click on a point to select your estimate. "?" means "unsure" and "☕" means "I need a break".',
      selector: '#deck',
      position: 'top-right',
    ...
    return (
      <div className="panel panel-default" id="deck">
        <div className="panel-heading">
          Vote
          <span className="pull-right"><i className="fa fa-info-circle"></i> Click to vote</span>
        </div>
